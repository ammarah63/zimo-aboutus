        ...
        <div className="lg:grid lg:grid-cols-3 lg:gap-4 md:grid md:grid-cols-3 md:gap-2">
          <div className="flex justify-center mt-12 lg:mt-0 md:mt-0">
            <div>
              ...
              <div
                className="lg:ml-6 md:ml-6"
                data-aos="fade-up"
                data-aos-once="true"
              >
                <p className="text-lg mt-5 xl:text-4xl lg:text-2xl text-center lg:text-left md:text-left tracking-widest">
                  OUR SOURCE
                </p>
                <p className="text-2xl lg:text-4xl xl:text-6xl text-center lg:text-left md:text-left tracking-widest lg:mt-3">
                  ENTRY TICKETS
                </p>
                <p className="text-nowrap text-xs text-center xl:text-2xl lg:text-left md:text-left lg:text-sm tracking-widest lg:mt-5 opacity-45">
          ...
          <div className="mt-16 lg:mt-5 col-span-2 ml-auto ">
            ...
            <p
              className="text-sm lg:text-base xl:text-2xl tracking-widest mt-3 lg:mt-10 text-center"
              data-aos="fade-up"
              data-aos-once="true"
            >
