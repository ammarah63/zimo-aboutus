...
const RealStateSection = () => {
  ...
  return (
    <>
      <div
        id="realStateSection"
        className="bg-white bg-center relative h-screen py-5 ps-2 md:px-5 lg:px-10 "
      >
        <div>
          <p
            className="text-center md:mt-0 xl:mt-4 4xl:mt-10 text-[0.5rem] md:text-[0.6rem] lg:text-sm 3xl:text-lg 4xl:text-3xl tracking-widest"
            data-aos="fade-up"
            data-aos-once="true"
          >
              ...
              >
                <div className="flex items-center justify-center mt-20 md:mt-0">
                  <Image
                    ...
                    width={100}
                    height={100}
                    className="min-w-40 md:min-w-44 lg:min-h-20 lg:min-w-96 3xl:min-w-[28vw] "
                  />
                </div>
                <p className="text-center text-nowrap text-[0.5rem] md:text-[0.6rem] lg:text-sm 3xl:text-lg 4xl:text-3xl  4xl:mt-16 md:tracking-widest mt-3">
                  CONNECTING USERS FROM ACROSS THE GLOBE
                </p>
                <p className="text-center  text-[0.5rem] md:text-[0.6rem] lg:text-sm 3xl:text-lg 4xl:text-3xl 4xl:my-5 md:tracking-widest">
                  TO FACILITATE LIFE&apos;S MOST IMPORTANT
                </p>
                <p className="text-center  text-[0.5rem] md:text-[0.6rem] lg:text-sm 3xl:text-lg 4xl:text-3xl md:tracking-widest">
                  PERSONAL TRANSACTIONS
                </p>
              </div>
            </div>
            <div className="grid grid-cols-2 gap-1 mt-32 md:mt-0  xl:mt-auto 3xl:mt-10">
              <div
                data-aos="fade-right"
                data-aos-once="true"
              ...
              >
                ...
                <p className="tracking-widest text-[0.5rem] md:text-[0.6rem] lg:text-sm 2xl:text-lg 2xl:tracking-[0.17em] 4xl:text-3xl 4xl:mt-16 3xl:text-lg 3xl:tracking-[0.2em] mt-2 2xl:mt-7">
