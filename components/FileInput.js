...
const FileInput = ({ onChange, onBlur, name, filename }) => {
  ...
  return (
    <>
      <div className="w-[86vw] md:w-[78vw] 4xl:my-5 3xl:my-2 lg:my-2 lg:w-[40vw] h-10 3xl:text-xl 4xl:text-4xl 3xl:h-14 4xl:h-16 lg:h-12 text-sm lg:text-lg !p-0 focus:outline-none border-1 border-inputgrey !text-center px-3 rounded-lg focus:border-1 focus:border-Date cursor-pointer">
