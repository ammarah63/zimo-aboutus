...
const OneSourceSection = () => {
  return (
    <>
      <div className="bg-white bg-center h-screen p-10 ">
            ...
            <div>
              <div className="flex ml-6 justify-center items-center">
                <Image
                  ...
                  width={100}
                  height={100}
                  className="min-h-36 min-w-[26vw] mt-32"
                  data-aos="fade-left"
                  data-aos-once="true"
                />
              </div>
              <div className="ml-6" data-aos="fade-up" data-aos-once="true">
                <p className="text-2xl tracking-widest">OUR SOURCE</p>
                <p className="text-4xl tracking-widest mt-3">ENTRY TICKETS</p>
                <p className="text-sm tracking-widest mt-5 opacity-45">
          ...
          <div className="mt-5 col-span-2 ml-auto pe-10 ">
            <div className="flex justify-center items-center">
              <Image
                ...
                width={100}
                height={100}
                className="min-h-96 min-w-[52vw]  "
                data-aos="fade-right"
                data-aos-once="true"
              />
            </div>
            <p
              className="text-base tracking-widest mt-10 text-center"
              data-aos="fade-up"
              data-aos-once="true"
            >
